...
class GoogleMapDownloader:
    ...
    def generateImage(self, **kwargs):
        ...
        tile_width = kwargs.get('tile_width', 10)
        tile_height = kwargs.get('tile_height', 10)
...
def main():
    ...
    gmd = GoogleMapDownloader(-18.934185, -48.796231, 18)
    ...
    try:
        ...
        img.save("FazendaConquistaMG_18.png")
